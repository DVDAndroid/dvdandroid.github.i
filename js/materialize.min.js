...
Vel = $ ? $.Velocity : Velocity, function (a) {
    ...
    a.fn.extend({
        openModal: function (b) {
            ...
            b = a.extend(e, b), b.dismissible && (a("#lean-overlay").click(function () {
                ...
                duration: b.in_duration, queue: !1, ease: "easeOutCubic", complete: function () {
                    "function" == typeof b.ready && b.ready()
                }
            }) : (a(c).css({top: "4%"}), a(c).velocity({
                top: "10%",
                opacity: 1
            }, {
                duration: b.in_duration, queue: !1, ease: "easeOutCubic", complete: function () {
            ...
            j.appendTo(i), j.css({
                ...
                mouseenter: function () {
                    ...
                    a = void 0 == a || "" == a ? b.delay : a, c = 0, e = setInterval(function () {
                        if (c += 10, c >= a && 0 == d) {
                            ...
                            "top" === h ? (i.css({
                                ...
                                duration: 350,
                                queue: !1
                            }), j.css({display: "block"}).velocity({opacity: 1}, {
                                duration: 55,
                                delay: 0,
                                queue: !1
                            }).velocity({scale: o}, {
                    ...
                    clearInterval(e), c = 0, i.velocity({
                        ...
                        marginTop: 0,
                        marginLeft: 0
                    }, {duration: 225, queue: !1, delay: 275}), j.velocity({
                        opacity: 0,
                        scale: 1
                    }, {
    ...
    function e(a) {
        ...
        return h.on("pan", function (a) {
            ...
            0 > e && (e = 0), Vel(b, {left: c, opacity: e}, {
                duration: 50,
                queue: !1,
                easing: "easeOutQuad"
            })
    ...
    a.scrollSpy = function (b, d) {
        ...
        b = a(b), b.each(function (b, c) {
            g.push(a(c)), a(c).data("scrollSpy:id", b), a("a[href=#" + a(c).attr("id") + "]").click(function (b) {
                ...
                a("html, body").animate({scrollTop: c - 200}, {
                    duration: 400,
                    queue: !1,
                    easing: "easeOutCubic"
                })
