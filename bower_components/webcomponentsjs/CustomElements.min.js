...
"undefined" == typeof WeakMap && !function () {
            ...
            enqueue: function (e) {
                ...
                switch (e.stopImmediatePropagation(), e.type) {
                    ...
                    case"DOMNodeInserted":
                        ...
                        var m = f.previousSibling, p = f.nextSibling, r = u("childList", e.target.parentNode);
    ...
    var w, v = e.isIE, h = e.upgradeDocumentTree, g = e.upgradeAll, b = e.upgradeWithDefinition, E = e.implementPrototype, _ = e.useNative, y = ["annotation-xml", "color-profile", "font-face", "font-face-src", "font-face-uri", "font-face-format", "font-face-name", "missing-glyph"], N = {}, M = "http://www.w3.org/1999/xhtml", O = document.createElement.bind(document), D = document.createElementNS.bind(document);
