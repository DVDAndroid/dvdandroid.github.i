...
"undefined" == typeof WeakMap && !function () {
    ...
    function i(e, t) {
        ...
        if (c)for (var h, m = 0; c > m && (h = s[m]); m++)a(h) ? (u.push(this), d++, n()) : (h.addEventListener("load", r), h.addEventListener("error", i)); else n()
    }
    ...
    l && (new MutationObserver(function (e) {
        ...
        if ("loading" === document.readyState)for (var e, t = document.querySelectorAll("link[rel=import]"), n = 0, r = t.length; r > n && (e = t[n]); n++)c(e)
    }()), t(function (e) {
