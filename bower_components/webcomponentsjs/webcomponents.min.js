...
!function () {
    ...
    t.prototype = Object.create(n.prototype), s(t.prototype, {
        constructor: t, get innerHTML() {
            ...
            var t = p(e);
            if (t === this.host)return null;
            for (; !this.contains(t) && !this.host.contains(t);) {
    ...
    function i(e, t) {
        ...
        if (l)for (var p, h = 0; l > h && (p = s[h]); h++)a(p) ? (u.push(this), c++, n()) : (p.addEventListener("load", r), p.addEventListener("error", i)); else n()
    }
